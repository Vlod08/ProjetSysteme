...
void execute_command(char* command) {
    ...
    int background = 0;
    printf("Background : 0   ;  Foreground : 1\n");
    scanf("%d",&background);
...
int main() {
    ...
    while (run) {
        ...
        if (strcmp(command,"exit") == 0){
        	...
        	pid_t processID;
        	scanf("%d",&processID);
        	printf("Moving the process with ID : %d to the foreground", processID);
        	move_to_foreground(processID);
        	...
        	pid_t processID;
        	scanf("%d",&processID);
        	printf("Moving the process with ID : %d to the background", processID);
        	move_to_foreground(processID);
        }
